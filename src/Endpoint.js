...
export default class Endpoint extends EventEmitter {
    ...
    constructor() {
        ...
        DeviceEventEmitter.addListener('pjSipConnectStateChanged', this._onConnectStateChanged.bind(this));
    }
    ...
    sendInstantMessage(account, sipServer, destination, msgBody) {
        console.log("sendInstantMessage?", account.getId(), sipServer, destination, msgBody)
        return new Promise(function (resolve, reject) {
            resolve()
            NativeModules.PjSipModule.sendInstantMessage(account.getId(), sipServer, destination, msgBody, (successful, data) => {
    ...
    /**
     * @fires Endpoint#connect_state_changed
     * @private
     * @param data {Object}
     */
    _onConnectStateChanged(data) {
        /**
         * Fires when registration status has changed.
         *
         * @event Endpoint#connect_state_changed
         * @property {Account} account
         */
        this.emit("connect_state_changed", data);
    }
