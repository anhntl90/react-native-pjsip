...
public class PjSipService extends Service {
    ...
    private void load() {
        ...
        try {
            ...
            }
            {
                TransportConfig transportConfig = new TransportConfig();
                transportConfig.setQosType(pj_qos_type.PJ_QOS_TYPE_VOICE);
                mTlsTransportId = mEndpoint.transportCreate(pjsip_transport_type_e.PJSIP_TRANSPORT_TLS,
                        transportConfig);
                mTrash.add(transportConfig);
            }
    ...
    private void handleSendMessage(Intent intent) {
        try {
            ...
            String buddy_uri = intent.getStringExtra("buddy_uri");
            String msgBody = intent.getStringExtra("msgBody");
            Log.d("ReactNative",
                    "handleSendMessage: accountId" + accountId + " buddy_uri: " + buddy_uri + " msgBody: " + msgBody);
